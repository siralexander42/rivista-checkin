...
// ============================================
// BLOCK TYPE CREATOR UI - VERSIONE SEMPLICE
// ============================================
...
function openBlockTypeCreator(blockId = null) {
    ...
    document.getElementById('blockCSS').value = '';
    document.getElementById('blockJS').value = '';
    
    // Reset variables
    document.getElementById('variablesContainer').innerHTML = `
        <div class="variable-row">
            <input type="text" placeholder="nome (es: title)" class="var-name">
            <select class="var-type">
                <option value="text">Text</option>
                <option value="textarea">Textarea</option>
                <option value="image">Image</option>
            </select>
            <button onclick="removeVariable(this)">✕</button>
        </div>
    `;
    ...
    if (blockId) {
        ...
        if (block) {
            ...
            document.getElementById('blockCSS').value = block.css || '';
            document.getElementById('blockJS').value = block.js || '';
        }
    }
...
function addVariable() {
    ...
    newRow.innerHTML = `
        <input type="text" placeholder="nome variabile" class="var-name">
        <select class="var-type">
            <option value="text">Text</option>
            <option value="textarea">Textarea</option>
            <option value="image">Image</option>
...
function saveNewBlock() {
    ...
    document.querySelectorAll('.variable-row').forEach(row => {
        ...
        const varType = row.querySelector('.var-type').value;
        if (varName) {
    ...
    const blockData = {
        ...
        html: document.getElementById('blockHTML').value.trim(),
        css: document.getElementById('blockCSS').value.trim(),
        js: document.getElementById('blockJS').value.trim(),
        variables: variables,
